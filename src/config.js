const config = {
	...
	projectcards: [
		{ go: "🚀 前往", img: "/img/wallpaper/static/射箭少女/45.jpg", title: "Wiki", subtitle: "文章教程都在这里", text: "一般会放一些教程或者碎碎念吧", url: "https://ckong.top/#blog", show: false },
		{ go: "🗂️ 前往", img: "/img/wallpaper/static/射箭少女/peer.jpg", title: "markdown编辑器", subtitle: "便携的网页版markdown编辑器", text: "功能也许不是很完善，目前处于内侧阶段，想要获取内测资格可以联系我ck@ckong.top", url: "https://md.ckong.top", show: false },
